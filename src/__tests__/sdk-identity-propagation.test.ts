 ...
 * like SSEServerTransport.handlePostMessage() does in production — so this test
 * exercises the same AsyncLocalStorage propagation path the real transport uses.
 */
