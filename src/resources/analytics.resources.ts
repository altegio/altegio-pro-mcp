...
export function renderCoverage(): string {
  ...
  return [
    ...
    '- There is no ad-hoc report builder. Use the curated client-sales, retention, service-profitability and team-member-sales tools for those stable tables; custom tables, P&L and cash-flow remain unavailable.',
